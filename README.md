...
[![Docs](https://img.shields.io/badge/docs-live-brightgreen)](https://francescomaiomascio.github.io/ICE-Studio-Docs/)
[![Status](https://img.shields.io/badge/status-active-blue)](https://github.com/francescomaiomascio/ICE-Studio-Docs)
[![License](https://img.shields.io/badge/license-proprietary-lightgrey)](#)

Official documentation for **ICE Studio** —  
an **Integrated Cognitive Environment** for system-level software development.

This repository contains the **public documentation** for ICE Studio:
architecture, concepts, runtime model, and usage guidelines.
...
The private source repository is maintained separately:
...
<a href="https://www.buymeacoffee.com/francescomaiomascio">
  <img src="assets/buy-me-coffee-icon.png" alt="Buy Me a Coffee" width="200"/>
</a>
